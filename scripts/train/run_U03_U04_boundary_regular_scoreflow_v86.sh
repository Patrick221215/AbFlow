...
# ============================================================
# AbFlow v86: U02-anchored boundary-regular Score--Flow
# ============================================================
...
# U04: same U03 carrier plus an antithetic (+r,-r) paired functional-response
#      objective in symmetric/antisymmetric coordinates.
#
...
case "$EXP_ID" in
  U03_PCS_RC_LC_R1_FF_R3_BOUNDARY_REGULAR_CARRIER)
    ABLATION_PARENT=U02_PCS_RC_LC_R1_FF_R3_ENDPOINT_CANONICAL_HYBRID
    EXPERIMENT_FACTOR=boundary_regular_preconditioned_canonical_carrier
    MODULE_ID=U03_F01_BOUNDARY_REGULAR_CARRIER
    MODULE_PARENT=U02_ENDPOINT_CANONICAL_HYBRID
    SINGLE_FACTOR_ABLATION=true
    SOURCE_MODE=pcs_rc
    RECURRENT_PROPOSAL_CONTEXT=on
    LOSS_MODE=f01_r3_boundary_regular_carrier
    T_SAMPLING=uniform
    SAMPLER_MODE=f01_boundary_regular_carrier
  ...
  U04_PCS_RC_LC_R1_FF_R3_ANTITHETIC_BOUNDARY_REGULAR)
    ABLATION_PARENT=U03_PCS_RC_LC_R1_FF_R3_BOUNDARY_REGULAR_CARRIER
    EXPERIMENT_FACTOR=antithetic_symmetric_antisymmetric_field_response
    MODULE_ID=U04_F01_ANTITHETIC_BOUNDARY_REGULAR
    MODULE_PARENT=U03_F01_BOUNDARY_REGULAR_CARRIER
    SINGLE_FACTOR_ABLATION=true
    SOURCE_MODE=pcs_rc
    RECURRENT_PROPOSAL_CONTEXT=on
    LOSS_MODE=f01_r3_antithetic_boundary_regular
    T_SAMPLING=uniform
    SAMPLER_MODE=f01_boundary_regular_carrier
    COORD_PEP_AS_CONDITION=on
    SEQ_INPUT_MODE=pep_condition
  ...
  *)
    ...
    echo "Supported v86 experiments:"
    echo "  U03_PCS_RC_LC_R1_FF_R3_BOUNDARY_REGULAR_CARRIER"
    echo "  U04_PCS_RC_LC_R1_FF_R3_ANTITHETIC_BOUNDARY_REGULAR"
    exit 2
    ;;
esac
