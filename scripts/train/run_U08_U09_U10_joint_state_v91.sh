...
# ============================================================
# AbFlow v91: U03 placement credit + AbX-style joint X_t/S_t state
# ============================================================
...
# U07 hand-crafted 6D geometry adapter is deliberately disabled in all v91 runs.
export ABFLOW_STRUCTURE_SEQ_READOUT="off"

case "$EXP_ID" in
  U08_PCS_RC_LC_R1_FF_R3_PROGRESSIVE_ENDPOINT_CANONICAL_REFINEMENT)
    export ABFLOW_ABLATION_PARENT="U02_PCS_RC_LC_R1_FF_R3_ENDPOINT_CANONICAL_HYBRID"
    export ABFLOW_EXPERIMENT_FACTOR="refinement_depth_endpoint_to_u02_carrier_homotopy"
    export ABFLOW_SINGLE_FACTOR_ABLATION="true"
    export ABFLOW_MODULE_ID="U08_PROGRESSIVE_ENDPOINT_CANONICAL_REFINEMENT"
    export ABFLOW_MODULE_PARENT="U02_ENDPOINT_CANONICAL_HYBRID"

    export ABFLOW_SCOREFM_LOSS_MODE="f01_r3_progressive_endpoint_canonical_refinement"
    # Exact U02 sequence semantics for causal isolation of the structural change.
  ...
  U09_PCS_RC_LC_R1_FF_R3_JOINT_XT_ST_STATE)
    export ABFLOW_ABLATION_PARENT="U02_PCS_RC_LC_R1_FF_R3_ENDPOINT_CANONICAL_HYBRID"
    export ABFLOW_EXPERIMENT_FACTOR="synchronized_authoritative_joint_xt_st_state"
    # This is one coherent formulation change, but it requires paired consistency
    # switches (dual state + hard_exact + context off), so do not mislabel it as
    # a literal single-toggle ablation.
    export ABFLOW_SINGLE_FACTOR_ABLATION="false"
    export ABFLOW_MODULE_ID="U09_JOINT_XT_ST_STATE"
    export ABFLOW_MODULE_PARENT="U02_ENDPOINT_CANONICAL_HYBRID"

    export ABFLOW_SCOREFM_LOSS_MODE="f01_r3_endpoint_canonical_hybrid"
    export ABFLOW_DUAL_SEQUENCE_STATE="on"
    export ABFLOW_DUAL_SEQUENCE_ATOM_MODE="hard_exact"
    export ABFLOW_SEQUENCE_CONTEXT_MODE="off"
    export ABFLOW_SEQUENCE_RECYCLE_MODE="off"
    ;;

  U10_PCS_RC_LC_R1_FF_R3_JOINT_XT_ST_ABX_RECYCLE)
    export ABFLOW_ABLATION_PARENT="U09_PCS_RC_LC_R1_FF_R3_JOINT_XT_ST_STATE"
    export ABFLOW_EXPERIMENT_FACTOR="abx_style_detached_hard_sequence_recycle"
    export ABFLOW_SINGLE_FACTOR_ABLATION="true"
    export ABFLOW_MODULE_ID="U10_JOINT_XT_ST_ABX_RECYCLE"
    export ABFLOW_MODULE_PARENT="U09_JOINT_XT_ST_STATE"

    export ABFLOW_SCOREFM_LOSS_MODE="f01_r3_endpoint_canonical_hybrid"
    export ABFLOW_DUAL_SEQUENCE_STATE="on"
    export ABFLOW_DUAL_SEQUENCE_ATOM_MODE="hard_exact"
    export ABFLOW_SEQUENCE_CONTEXT_MODE="off"
    export ABFLOW_SEQUENCE_RECYCLE_MODE="hard_detached"
    ;;

  *)
    echo "Unknown EXP_ID: $EXP_ID"
    echo "Supported v91 experiments:"
    echo "  U08_PCS_RC_LC_R1_FF_R3_PROGRESSIVE_ENDPOINT_CANONICAL_REFINEMENT"
    echo "  U09_PCS_RC_LC_R1_FF_R3_JOINT_XT_ST_STATE"
    echo "  U10_PCS_RC_LC_R1_FF_R3_JOINT_XT_ST_ABX_RECYCLE"
    exit 2
    ;;
esac
...
# ------------------------------------------------------------------
# attach watcher to an already-running v91 experiment
# ------------------------------------------------------------------
