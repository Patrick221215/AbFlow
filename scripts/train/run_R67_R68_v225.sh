...
usage() {
  cat >&2 <<'USAGE'
Usage:
  bash scripts/train/run_R67_R68_v225.sh <config.json> --gpus 2,3 --port 29767
...
if dw>0 and (scope!='generation_anchored' or red!='relation_balanced'): raise SystemExit('V225 trainable Distogram requires generation_anchored + relation_balanced')
