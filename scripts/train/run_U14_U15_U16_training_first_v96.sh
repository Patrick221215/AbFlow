...
# ============================================================
# AbFlow v96: training-first U14/U15/U16 factorial family
# ============================================================
...
# ============================================================
# Formal v96 variables are restricted to the two training factors below.
...
# U07 hand-crafted 6D geometry adapter is deliberately disabled in all v96 runs.
export ABFLOW_STRUCTURE_SEQ_READOUT="off"

case "$EXP_ID" in
  U14_PCS_RC_LC_R1_FF_R3_ROUND_CONSISTENT_CARRIER)
    export ABFLOW_ABLATION_PARENT="U02_PCS_RC_LC_R1_FF_R3_ENDPOINT_CANONICAL_HYBRID"
    export ABFLOW_EXPERIMENT_FACTOR="round_consistent_coordinate_supervision"
    export ABFLOW_SINGLE_FACTOR_ABLATION="true"
    export ABFLOW_MODULE_ID="U14_ROUND_CONSISTENT_CARRIER"
    ...
    export ABFLOW_SCOREFM_SAMPLER_MODE="f01_canonical_carrier"
    export ABFLOW_F01_HYBRID_T_MIN="0.20"
    export ABFLOW_ROUND_CONSISTENT_COORD_SUPERVISION="on"
  ...
  U15_PCS_RC_LC_R1_FF_R3_DFM_REFERENCE_SEQUENCE_STATE)
    export ABFLOW_ABLATION_PARENT="U02_PCS_RC_LC_R1_FF_R3_ENDPOINT_CANONICAL_HYBRID"
    export ABFLOW_EXPERIMENT_FACTOR="dfm_reference_sequence_state"
    export ABFLOW_SINGLE_FACTOR_ABLATION="true"
    export ABFLOW_MODULE_ID="U15_DFM_REFERENCE_SEQUENCE_STATE"
    export ABFLOW_MODULE_PARENT="U02_ENDPOINT_CANONICAL_HYBRID"
    export ABFLOW_SCOREFM_LOSS_MODE="f01_r3_endpoint_canonical_hybrid"
    export ABFLOW_SCOREFM_SAMPLER_MODE="f01_canonical_carrier"
    export ABFLOW_F01_HYBRID_T_MIN="0.20"
    export ABFLOW_ROUND_CONSISTENT_COORD_SUPERVISION="off"
    export ABFLOW_SEQUENCE_SOURCE_MODE="reference_uniform"
    export ABFLOW_SEQ_INPUT_MODE="pep_condition"
  ...
  U16_PCS_RC_LC_R1_FF_R3_ROUND_CONSISTENT_JOINT_DFM)
    export ABFLOW_ABLATION_PARENT="U02_PCS_RC_LC_R1_FF_R3_ENDPOINT_CANONICAL_HYBRID"
    export ABFLOW_EXPERIMENT_FACTOR="round_consistent_plus_dfm_reference_state"
    export ABFLOW_SINGLE_FACTOR_ABLATION="false_factorial_combination"
    export ABFLOW_MODULE_ID="U16_ROUND_CONSISTENT_JOINT_DFM"
    export ABFLOW_MODULE_PARENT="U02_ENDPOINT_CANONICAL_HYBRID"
    export ABFLOW_SCOREFM_LOSS_MODE="f01_r3_endpoint_canonical_hybrid"
    export ABFLOW_SCOREFM_SAMPLER_MODE="f01_canonical_carrier"
    export ABFLOW_F01_HYBRID_T_MIN="0.20"
  ...
  *)
    ...
    echo "Supported v96:"
    echo "  U14_PCS_RC_LC_R1_FF_R3_ROUND_CONSISTENT_CARRIER"
    echo "  U15_PCS_RC_LC_R1_FF_R3_DFM_REFERENCE_SEQUENCE_STATE"
    echo "  U16_PCS_RC_LC_R1_FF_R3_ROUND_CONSISTENT_JOINT_DFM"
    exit 2
    ;;
esac
...
# ------------------------------------------------------------------
# attach watcher to an already-running v96 experiment
# ------------------------------------------------------------------
