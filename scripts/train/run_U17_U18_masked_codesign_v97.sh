...
# ============================================================
# AbFlow v97: U17/U18 masked sequence replacement experiments
# ============================================================
# U14 continues independently under its existing v97.1 launcher.
#
# U17: one-way structure -> masked inverse folding
# U18: U17 + safe masked sequence-state -> structure hidden coupling
#
# Both freeze the U02 structural path/target/sampler.
# Both remove proposal-AA sequence information from the designed H3 graph,
# keep X_pep recurrent structural context, and use no recycle.
# ============================================================
# Existing U02 is the control.
# U14: same-quantity recurrent coordinate supervision.
# U15: DFM-style independent categorical source/state.
# U16: U14 + U15.
# ALL THREE TRAIN FROM SCRATCH AND KEEP U02 PATH/TARGET/SAMPLER.
# ============================================================
# Formal v97 variables are restricted to the two training factors below.
# Historical modes remain in the model only for old-checkpoint compatibility.
# ============================================================
...
case "$EXP_ID" in
  ...
  U18_PCS_RC_LC_R1_FF_R3_MASKED_JOINT_CODESIGN)
    export ABFLOW_ABLATION_PARENT="U17_PCS_RC_LC_R1_FF_R3_MASKED_INVERSE_FOLDING"
    export ABFLOW_EXPERIMENT_FACTOR="masked_joint_hidden_state_coupling"
    export ABFLOW_SINGLE_FACTOR_ABLATION="true"
    export ABFLOW_MODULE_ID="U18_MASKED_JOINT_CODESIGN"
    export ABFLOW_MODULE_PARENT="U17_MASKED_INVERSE_FOLDING"

    # Exact same U02 structural Score--Flow and exact same masked sequence task.
    export ABFLOW_SCOREFM_LOSS_MODE="f01_r3_endpoint_canonical_hybrid"
    export ABFLOW_SCOREFM_SAMPLER_MODE="f01_canonical_carrier"
    export ABFLOW_F01_HYBRID_T_MIN="0.20"
    export ABFLOW_ROUND_CONSISTENT_COORD_SUPERVISION="off"
    ...
    # Only factor relative to U17:
    # revealed S_t can condition the structural hidden state.
    # hidden_only is zero-start and never changes atom topology.
  ...
  *)
    ...
    echo "Supported v97:"
    echo "  U17_PCS_RC_LC_R1_FF_R3_MASKED_INVERSE_FOLDING"
    echo "  U18_PCS_RC_LC_R1_FF_R3_MASKED_JOINT_CODESIGN"
    exit 2
    ;;
esac
...
# ------------------------------------------------------------------
# attach watcher to an already-running v97 experiment
# ------------------------------------------------------------------
