...
SUPPORT_FACTORIZED_COORD=${ABFLOW_SUPPORT_FACTORIZED_COORD:-off}
TRANSLATION_ROUND_CREDIT=${ABFLOW_TRANSLATION_ROUND_CREDIT:-off}
...
case "$EXP_ID" in
  U25_PCS_RC_LC_R1_FF_R3_U02_SUPPORT_FACTORIZED)
    ABLATION_PARENT=U02_PCS_RC_LC_R1_FF_R3_ENDPOINT_CANONICAL_HYBRID
    EXPERIMENT_FACTOR=rank3_support_factorized_final_coordinate_objective
    MODULE_ID=U25_U02_SUPPORT_FACTORIZED
    ...
    BOUNDARY_PCGRAD=off
    SUPPORT_FACTORIZED_COORD=on
    TRANSLATION_ROUND_CREDIT=off
  ...
  U26_PCS_RC_LC_R1_FF_R3_U02_TRANSLATION_ROUND_CREDIT)
    ABLATION_PARENT=U02_PCS_RC_LC_R1_FF_R3_ENDPOINT_CANONICAL_HYBRID
    EXPERIMENT_FACTOR=translation_only_recurrent_credit_assignment
    MODULE_ID=U26_U02_TRANSLATION_ROUND_CREDIT
    MODULE_PARENT=U02_ENDPOINT_CANONICAL_HYBRID
    SINGLE_FACTOR_ABLATION=true
    SOURCE_MODE=pcs_rc
    RECURRENT_PROPOSAL_CONTEXT=on
    ...
    SAMPLER_MODE=f01_canonical_carrier
    BOUNDARY_PCGRAD=off
    SUPPORT_FACTORIZED_COORD=off
    TRANSLATION_ROUND_CREDIT=on
    COORD_PEP_AS_CONDITION=on
    SEQ_INPUT_MODE=pep_condition
    SHADOW_SEQ_STATE=off
    DUAL_SEQUENCE_STATE=off
  ...
  U27_PCS_RC_LC_R1_FF_R3_U02_SUPPORT_FACTORIZED_ROUND_CREDIT)
    ABLATION_PARENT=U02_PCS_RC_LC_R1_FF_R3_ENDPOINT_CANONICAL_HYBRID
    EXPERIMENT_FACTOR=support_factorized_plus_translation_round_credit
    MODULE_ID=U27_U02_SUPPORT_FACTORIZED_ROUND_CREDIT
    MODULE_PARENT=U02_ENDPOINT_CANONICAL_HYBRID
  ...
  *)
    ...
    echo "Supported v101:"
    echo "  U25_PCS_RC_LC_R1_FF_R3_U02_SUPPORT_FACTORIZED"
    echo "  U26_PCS_RC_LC_R1_FF_R3_U02_TRANSLATION_ROUND_CREDIT"
    echo "  U27_PCS_RC_LC_R1_FF_R3_U02_SUPPORT_FACTORIZED_ROUND_CREDIT"
    exit 2
    ;;
esac
...
run_with_env() {
  ...
  ABFLOW_SUPPORT_FACTORIZED_COORD="$SUPPORT_FACTORIZED_COORD" \
  ABFLOW_TRANSLATION_ROUND_CREDIT="$TRANSLATION_ROUND_CREDIT" \
  ABFLOW_AMP="$AMP" \
...
print_settings() {
  ...
  echo "SUPPORT_FACTORIZED_COORD=$SUPPORT_FACTORIZED_COORD"
  echo "TRANSLATION_ROUND_CREDIT=$TRANSLATION_ROUND_CREDIT"
