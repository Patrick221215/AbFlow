...
# ============================================================
# AbFlow v64: genuine global-R3 Score + canonical Gaussian Flow core stage
# ============================================================
...
case "$EXP_ID" in
  PCS_RC_LC_R1_FF_R3_TRUE_SCORE|SF01_TRUE_R3_SCORE)
    ABLATION_PARENT=PCS_RC_LC_R1_FF_R3_GLOBAL_ENDPOINT
    EXPERIMENT_FACTOR=genuine_global_r3_dsm
    MODULE_ID=SF01_TRUE_R3_SCORE
    MODULE_PARENT=F01_FF_R3_GLOBAL_ENDPOINT
    SINGLE_FACTOR_ABLATION=true
    SOURCE_MODE=pcs_rc
    RECURRENT_PROPOSAL_CONTEXT=on
    LOSS_MODE=foldflow_r3_global_score
    T_SAMPLING=uniform
    SAMPLER_MODE=bridge
  ...
  PCS_RC_LC_R1_FF_R3_CANONICAL_PATHFLOW|SF02_CANONICAL_R3_FLOW)
    ABLATION_PARENT=PCS_RC_LC_R1_FF_R3_GLOBAL_ENDPOINT
    EXPERIMENT_FACTOR=canonical_global_r3_flow
    MODULE_ID=SF02_CANONICAL_R3_FLOW
    MODULE_PARENT=F01_FF_R3_GLOBAL_ENDPOINT
    SINGLE_FACTOR_ABLATION=true
    SOURCE_MODE=pcs_rc
    RECURRENT_PROPOSAL_CONTEXT=on
    LOSS_MODE=foldflow_r3_global_pathflow
    T_SAMPLING=uniform
  ...
  PCS_RC_LC_R1_FF_R3_TRUE_SCORE_FLOW|SF03_TRUE_R3_SCORE_FLOW)
    ABLATION_PARENT=PCS_RC_LC_R1_FF_R3_GLOBAL_ENDPOINT
    EXPERIMENT_FACTOR=genuine_r3_score_plus_canonical_flow
    MODULE_ID=SF03_TRUE_R3_SCORE_FLOW
    MODULE_PARENT=F01_FF_R3_GLOBAL_ENDPOINT
    SINGLE_FACTOR_ABLATION=false
    SOURCE_MODE=pcs_rc
    RECURRENT_PROPOSAL_CONTEXT=on
    LOSS_MODE=foldflow_r3_global_scoreflow
    T_SAMPLING=uniform
    SAMPLER_MODE=r3_scoreflow
    COORD_PEP_AS_CONDITION=on
    SEQ_INPUT_MODE=pep_condition
  ...
  *)
    ...
    echo "Supported formal v64 Score-Flow profiles:"
    echo "  PCS_RC_LC_R1_FF_R3_TRUE_SCORE"
    echo "  PCS_RC_LC_R1_FF_R3_CANONICAL_PATHFLOW"
    echo "  PCS_RC_LC_R1_FF_R3_TRUE_SCORE_FLOW"
    exit 2
    ;;
esac
...
if [[ "$MODE" != "train" ]]; then
  ...
  echo "v64 EXP_ID: PCS_RC_LC_R1_FF_R3_TRUE_SCORE, PCS_RC_LC_R1_FF_R3_CANONICAL_PATHFLOW, PCS_RC_LC_R1_FF_R3_TRUE_SCORE_FLOW"
  exit 2
fi
