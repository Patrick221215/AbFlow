...
# ============================================================
# AbFlow v71: source-audited conditional SF2M-R3 stage
# ============================================================
...
case "$EXP_ID" in
  ...
  F02_PCS_RC_LC_R1_SF2M_R3_TIED_SCORE_CONTROL)
    ...
    EXPERIMENT_FACTOR=time_only_weighted_tied_score_consistency
    MODULE_ID=F02_SF2M_R3_TIED_SCORE_CONTROL
    MODULE_PARENT=F01_SF2M_R3_CANONICAL_FLOW
    SINGLE_FACTOR_ABLATION=true
    SOURCE_MODE=pcs_rc
    RECURRENT_PROPOSAL_CONTEXT=on
    LOSS_MODE=sf2m_r3_tied_score_control
    T_SAMPLING=sf2m_uniform
    SAMPLER_MODE=sf2m_ode
    COORD_PEP_AS_CONDITION=on
    SEQ_INPUT_MODE=pep_condition
  ...
  F03_PCS_RC_LC_R1_SF2M_R3_DUALFIELD_SCORE_FLOW)
    ABLATION_PARENT=F02_PCS_RC_LC_R1_SF2M_R3_TIED_SCORE_CONTROL
    EXPERIMENT_FACTOR=independent_equivariant_raw_score_plus_same_flow
    MODULE_ID=F03_SF2M_R3_DUALFIELD_SCORE_FLOW
    MODULE_PARENT=F01_SF2M_R3_CANONICAL_FLOW
    SINGLE_FACTOR_ABLATION=true
    SOURCE_MODE=pcs_rc
    RECURRENT_PROPOSAL_CONTEXT=on
    LOSS_MODE=sf2m_r3_dualfield_score_flow
    T_SAMPLING=sf2m_uniform
    SAMPLER_MODE=${ABFLOW_SF2M_F03_SAMPLER_MODE:-sf2m_ode}
    COORD_PEP_AS_CONDITION=on
    SEQ_INPUT_MODE=pep_condition
    SHADOW_SEQ_STATE=off
    DUAL_SEQUENCE_STATE=off
  ...
  *)
    ...
    echo "Supported v71 experiments:"
    echo "  F01_PCS_RC_LC_R1_SF2M_R3_CANONICAL_FLOW"
    echo "  F02_PCS_RC_LC_R1_SF2M_R3_TIED_SCORE_CONTROL"
    echo "  F03_PCS_RC_LC_R1_SF2M_R3_DUALFIELD_SCORE_FLOW"
    exit 2
    ;;
esac
